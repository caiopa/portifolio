            ...
            <h3 id="sobreMim" className="a text-center mb-5 fs-2" data-aos="fade-up" data-aos-duration="1000">Sobre mim</h3>
              <div className='fs-5'>
                <p className="text-justify lh-base" data-aos="fade-up">
                  Tenho 29 anos sou de Volta Redonda, Rj, sou formado em  Tecnico de eletromecanica, Engenharia Civil e Desenvolvedor Web Full-Stack, possuo habilidades em back-end, front-end e banco de dados, tenho experiencia anterios em manutenção eletrica industrial,residencial e engenharia civil, como fiscalzação de obra e projetos, um pouco dos meus hobbies é, viajar, ver filmes/series, comer, jogar, codar, estar com amigos e familia.
                </p>
                <p className="text-justify lh-base" data-aos="fade-up">
